...
export class Az900DashboardComponent {
   ...
   b3Sub1Bottom = computed(() =>
      this.joint3Sub1() ? this.yB3Sub1Nested() + this.NODE_H : this.cyJ3Sub1() + this.J2_R,
   );
   ...
   pathToAPNested = computed(() =>
      this.p(this.L2_JCX, this.cyJAP(), this.L3_X, this.yAPNested() + 20),
   );
   pathToIniciativas = computed(() =>
      this.p(this.L2_JCX, this.cyCostJ(), this.L3_X, this.yIniciativas() + 20),
   );
   ...
   pathToB2Nested = computed(() =>
      this.p(this.L2_JCX, this.cyJ2Sub(), this.L3_X, this.yB2Nested() + 20),
   );
   ...
   pathJB3Sub1 = computed(() =>
      this.vp(this.L2_JCX, this.yB3Sub1() + this.NODE_H, this.cyJ3Sub1()),
   );
   pathToB3Sub1Nested = computed(() =>
      this.p(this.L2_JCX, this.cyJ3Sub1(), this.L3_X, this.yB3Sub1Nested() + 20),
   );
   ...
   overallProgress = computed(() =>
      Math.round(this.modules().reduce((s, m) => s + m.progress, 0) / this.modules().length),
   );
   activeModulesCount = computed(() => this.modules().filter((m) => m.status !== 'locked').length);
   ringOffset = computed(() => {
      const c = 2 * Math.PI * 32;
      return c - (this.overallProgress() / 100) * c;
   });
